...
## 本项目获取地址：https://www.bishecode.com/product/246/
...
图5.2 装修样板管理页面【如图5.2显示的就是装修样板管理页面，此页面提供给管理员的功能有：查看已发布的装修样板数据，修改装修样板，装修样板作废，即可删除，还进行了对装修样板名称的模糊查询 装修样板信息的类型查询等等一些条件。】
![alt text](images/image-5.png)

图5.3 装修队管理页面【如图5.3显示的就是装修队管理页面，此页面提供给管理员的功能有：根据装修队进行条件查询，还可以对装修队进行新增、修改、查询操作等等。】
